...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Object storage routes for expense receipts
  ...
  app.put("/api/expense-attachments", isAuthenticated, async (req, res) => {
    ...
    try {
      ...
      console.error("Error setting expense attachment:", error);
